      ...
      <div className="">
        <div className="md:mx-32 mb-4 mt-10">
          ...
          <p className="mt-5">
            ...
            people to recreational sports. Playing sports in a universal
            language and our platform will give enthusiasts a unique way to
            challenge each other. Our goal with this project is to allow an easy
            entry into web3. We believe the best innovations with the new
            technology will incorporate web3 elements without saying web3 or
            blockchain.
          </p>
        </div>
        ...
        <div className="flex md:flex-row flex-col justify-around items-center md:mb-48 mb-10">
          ...
          <div className="mb-4">
            ...
            <p className="text-center italic text-xl">
              Clement James Jnr
              <br />
              <a target="_blank" href="https://github.com/jaymesC">
                GitHub @jaymesC
              </a>
            </p>
          </div>
