...
export const TeamCard = ({ team, teamObject = null }) => {
    ...
    return (
      <div className="flex animate-out fade-out flex-col my-4 md:w-full w-96 ml-[4.2rem] md:ml-0 justify-center items-start border-2 border-gray-200 p-2 rounded-lg shadow-lg bg-white hover:shadow-2xl transition ease-in-out delay-100  hover:ease-in-out">
